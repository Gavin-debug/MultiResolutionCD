...
class FPT_6in1(nn.Module):
    def __init__(self):
        super(FPT_6in1,self).__init__()
    ...
    def forward(self, x1, x2):
        ...
        tokens = torch.cat((token_x1_64,token_x1_128,token_x1_256,token_x2_64, token_x2_128, token_x2_256), dim=1)
        token_x2 = self.transformer(tokens)
        token_x1_64n, token_x1_128n, token_x1_256n, token_x2_64n, token_x2_128n, token_x2_256n = token_x2.chunk(6, dim=1)
